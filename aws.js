...
// To run the script from Google Apps Script
// fetch = UrlFetchApp
...
const payload = { "TableName": "lil-goodness", "Key": { "code": { "S": "sfwet" } }, "UpdateExpression": "SET logo = :logo, video = :video", "ExpressionAttributeValues": { ":logo": { "S": "hawtp" }, ":video": { "S": "asfwee" } }, "ReturnValues": "NONE" };

await AWS.request('dynamodb', 'ap-south-1', 'DynamoDB_20120810.UpdateItem', {}, 'POST', payload).then(async (res) => {
